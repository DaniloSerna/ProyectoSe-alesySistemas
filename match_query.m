function [song, offset] = match_query(query, database, canciones)

%% match_query - Guesses the given song 
%
% [song, offset] = match_query(query, database, canciones)
%
...
% title
%else
     disp(sprintf('El fragmento analizado pertenece a %s', canciones{song,1}(:)))
end
